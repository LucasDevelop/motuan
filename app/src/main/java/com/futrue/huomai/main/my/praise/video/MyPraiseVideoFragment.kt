...
class MyPraiseVideoFragment :
    BaseRefreshListFragment<MyPraiseVideoPresenter, IBean, PersonalVideoAdapter>() {


    override fun getLayoutID(): Int = R.layout.fragment_my_praise_video
