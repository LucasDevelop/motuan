...
class MyPraiseLookFragment :
    BaseRefreshListFragment<MyPraiseLookPresenter, IBean, PersonalLookAdapter>() {



    override fun getLayoutID(): Int = R.layout.fragment_my_praise_look
