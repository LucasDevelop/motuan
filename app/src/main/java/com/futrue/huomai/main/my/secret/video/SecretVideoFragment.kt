...
class SecretVideoFragment :
    BaseRefreshListFragment<SecretVideoPresenter, IBean, PersonalVideoAdapter>() {


    override fun getLayoutID(): Int = R.layout.fragment_secret_video
