...
public class CustomProgress extends Dialog {
    ...
    public void show(String title, View.OnClickListener itemListener, ArrayList<String> dates,
        ...
        TextView textView;
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, SizeUtils.dp2px( 44));
        LinearLayout.LayoutParams lineParam = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,SizeUtils.dp2px(0.2f));
        lineParam.leftMargin = SizeUtils.dp2px(15f);
        lineParam.rightMargin =SizeUtils.dp2px(15);
        for (int i = 0; i < dates.size(); i++) {
            ...
            textView.setId(i);
            textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, SizeUtils.dp2px( 16));
