...
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * @param layoutManager
     */
    public GridDividerItemDecoration(int leftRight, int topBottom, int headItemCount, @LayoutManager int layoutManager) {
     ...
     * @param layoutManager
     */
    public GridDividerItemDecoration(int space,boolean includeEdge, @LayoutManager int layoutManager) {
     ...
     * @param layoutManager
     */
    public GridDividerItemDecoration(int space,int headItemCount,boolean includeEdge, @LayoutManager int layoutManager) {
        this.space = space;
        this.headItemCount = headItemCount;
     ...
     * @param layoutManager
     */
    public GridDividerItemDecoration(int space,int headItemCount, @LayoutManager int layoutManager) {
     ...
     * @param layoutManager
     */
    public GridDividerItemDecoration(int space, @LayoutManager int layoutManager) {
