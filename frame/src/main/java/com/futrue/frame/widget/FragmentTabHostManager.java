...
public class FragmentTabHostManager extends TabHost implements
    ...
    public FragmentTabHostManager(Context context) {
    ...
    public FragmentTabHostManager(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public FragmentTransaction doTabChanged(String tabId,
