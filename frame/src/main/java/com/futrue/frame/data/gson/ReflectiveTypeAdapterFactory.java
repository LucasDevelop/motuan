...
//                Log.i("string",string);
                try {
                    //string 里面再次不符合json格式 不再解析了
//                    Log.i("T",constructor.getClass().getName());
//                    Log.i("T",((T)constructor).getClass().getName());
                    T construct = constructor.construct();
//                    Log.i("T",construct.getClass().getName());
                    return (T) CustomGson.newGson().fromJson(string, construct.getClass());
                }catch (Exception e){
                    e.printStackTrace();
                }
                return constructor.construct();
